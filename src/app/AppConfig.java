...
public class AppConfig {
	...
	public static SKTokenMutex tokenMutex;
	
	public static ChordState chordState;
	public static String WORKSPACE_DIR;
	public static boolean gotPongFromSuccessor=false;
	public static boolean gotPingFromPredecessor=false;
	...
	public static void readConfig(String configName, int serventId){
		...
		WORKSPACE_DIR= properties.getProperty("workspace");
		File f=new File(WORKSPACE_DIR);
		if(!f.exists()) {
			timestampedErrorPrint("Problem reading workspace " + f.getAbsolutePath());
			System.exit(0);
		}
